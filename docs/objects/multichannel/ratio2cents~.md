...
The `ratio2cents~` object converts a signal representing a rational interval (e.g., a frequency ratio) into an interval expressed in cents. It performs the calculation `cents = log2(ratio) * 1200`. This object also supports multichannel signal connections.
