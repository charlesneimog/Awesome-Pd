...
The `tanh` object calculates the hyperbolic tangent of its input. It is available in both control (`cyclone/tanh`) and signal (`cyclone/tanh~`) versions, making it suitable for various mathematical operations within Pure Data patches.
