...
The `tabreader~` object reads signal data from a Pure Data array (table). It supports various interpolation methods and multichannel arrays, allowing for flexible waveform playback. When used with a `phasor~` in loop mode, it functions as a wavetable oscillator.
