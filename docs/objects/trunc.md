...
The `trunc` object truncates floating-point numbers and lists of numbers towards zero, effectively extracting their integer part. It functions similarly to Pure Data's built-in `int` object but also supports processing lists of values.
