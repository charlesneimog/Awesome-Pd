...
`unmerge` separates the elements of a message in groups of any size (default 1). Each group is sent out a separate outlet, extra elements are sent to an extra rightmost outlet.
