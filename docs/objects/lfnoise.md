...
`lfnoise` is a control-rate low-frequency noise generator that outputs random values between 0 and 127. It operates independently of the DSP engine and can be configured with a frequency and interpolation. Users can provide a seed for reproducible random sequences.
